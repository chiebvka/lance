import {
  ...
  export default function InvoiceReminder({
    ...
    const previewText = ` ${invoiceName} is ready to be paid.`
    const finalInvoiceLink = invoiceLink || `${baseUrl}/i/${invoiceId}`;
              ...
              <Row>
                ...
                <Column style={{ paddingLeft: "20px" }}>
                  <Heading as="h1" style={headerTitleStyle}>
                    Your invoice {invoiceName} is overdue!
                  </Heading>
            ...
            <Section style={contentStyle}>
              ...
              <Section style={codeBlockStyle}>
                ...
                <Text style={codeLineStyle}>
                  {`Your invoice ${invoiceName} is overdue. Please take a moment to pay it to avoid any late fees.`}
                </Text>
              </Section>
  
              <Button href={finalInvoiceLink} style={buttonStyle}>
                View Invoice
              </Button>
