          ...
          <Container style={container}>
              ...
              <Row>
                ...
                <Column style={{ paddingLeft: "20px", verticalAlign: "top" }}>
                  <Heading as="h1" style={headerTitleStyle}>
                    {projectName} has been signed off!
                  </Heading>
            ...
            <Section style={contentStyle}>
              ...
              <Section style={codeBlockStyle}>
                <Text style={codeHeaderStyle}>{`${projectName} signed off!`}</Text>
                <Text style={codeLineStyle}>
                    {`Your project ${projectName} has been signed off successfully. Thank you for your business!`}
                </Text>
              </Section>
