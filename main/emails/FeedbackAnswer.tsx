import {
  ...
  export default function FeedbackAnswer({
    ...
    clientName = "Client",
    feedbackName = "Your Project",
    feedbackId = "123",
    logoUrl = "https://www.bexoni.com/favicon.ico",
    feedbackLink,
  }: IssueProjectEmailProps) {
    const previewText = ` ${feedbackName} has been answered.`
          ...
          <Container style={container}>
              ...
              <Row>
                ...
                <Column style={{ paddingLeft: "20px", verticalAlign: "top" }}>
                  <Heading as="h1" style={headerTitleStyle}>
                    {feedbackName} has been answered!
                  </Heading>
                  <Text style={headerSubtitleStyle}>
                    {feedbackName} • From {senderName}
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section style={contentStyle}>
              ...
              <Section style={codeBlockStyle}>
                <Text style={codeHeaderStyle}>{`${feedbackName} answered!`}</Text>
                <Text style={codeLineStyle}>
                    {`Your questions for form  ${feedbackName} have been answered successfully. Thank you for your business!`}
                </Text>
              </Section>
