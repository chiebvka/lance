            ...
            <Section style={contentStyle}>
              ...
              <Section style={codeBlockStyle}>
                ...
                <Text style={codeLineStyle}>
                  {"We're pleased that you've given us a chance, we just have a couple of questions for you " +
                    (clientName) +
                    " to help us improve our service. Please take a moment to fill out the form to help us serve you better"}
                </Text>
              </Section>
