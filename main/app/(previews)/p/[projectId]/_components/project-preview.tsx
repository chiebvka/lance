...
export default function ProjectPreview({ projectId, token }: ProjectPreviewProps) {
  ...
  const orgName = project.organizationId?.name || project.organizationName || 'Company'
  const logoUrl = project.organizationId?.logoUrl || project.organizationLogo || null
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {logoUrl ? (
                <img src={logoUrl} alt={orgName} className="w-10 h-10 rounded-lg object-contain bg-white/20 p-1" />
              ) : (
              ...
              <div>
                ...
                <p className="text-purple-100">{orgName}</p>
              </div>
            </div>
